    ...
    private void init() {
        ...
        setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                view.setData(CalendarFactory.getMonthOfDayList(dateArr[0], dateArr[1] + position - Integer.MAX_VALUE / 2),
        ...
        addOnPageChangeListener(new SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (onItemClickListener != null) {
                    ...
                    Object[] objects = view.getSelect();
                    onItemClickListener.onItemClick((View) objects[0], (int) objects[1], (CalendarBean) objects[2]);
                }
