package me.khrystal.customtransition;
...
public abstract class TransitionController implements View.OnFocusChangeListener {
    ...
    protected TransitionController(WeakReference<Activity> activityWeakReference,
                                   @NonNull AnimatorBuilder animatorBuilder) {
