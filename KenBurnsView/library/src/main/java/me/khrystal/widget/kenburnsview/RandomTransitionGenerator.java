...
public class RandomTransitionGenerator implements TransitionGenerator {
    ...
    public RandomTransitionGenerator(long transitionDuration, Interpolator transitionInterpolator) {
        setTransitionDurtaion(transitionDuration);
        setTransitionInterpolator(transitionInterpolator);
    }

    public void setTransitionDurtaion(long transitionDuration) {
    ...
    public Transition generateNextTransition(RectF drawableBounds, RectF viewport) {
        ...
        boolean viewporttRatioChanged = true;
        ...
        if (!firstTransition) {
            ...
            viewporttRatioChanged = !MathUtils.haveSameAspectRation(dstRect, viewport);
        }

        if (dstRect == null || drawableBoundsChanged || viewporttRatioChanged) {
    ...
    private RectF generateRandomRect(RectF drawableBounds, RectF viewportRect) {
        ...
        float viewprotRectRatio = MathUtils.getRectRatio(viewportRect);
        RectF maxCrop;

        if (drawableRatio > viewprotRectRatio) {
