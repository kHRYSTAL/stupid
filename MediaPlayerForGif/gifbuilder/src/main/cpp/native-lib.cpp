...
#include "me_khrystal_gifbuilder_encoder_GIFEncoder.h"
#ifndef eprintf
...
JNIEXPORT jbyteArray JNICALL Java_me_khrystal_gifbuilder_encoder_GIFEncoder_getImagePixelsNative(JNIEnv *env, jclass clazz,
                                                                    jobject zBitmap) {
    // TODO: implement getImagePixelsNative()
    JNIEnv J = *env;
    // Get bitmap info
