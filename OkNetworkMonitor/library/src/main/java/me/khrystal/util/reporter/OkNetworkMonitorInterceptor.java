...
import me.khrystal.util.stetho.DefaultResponseHandler;
import me.khrystal.util.stetho.NetworkEventReporter;
import me.khrystal.util.stetho.RequestBodyHelper;
...
public class OkNetworkMonitorInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (mEventReporter.isEnabled()) {
            ...
            mEventReporter.responseHeadersReceived(new OkHttpInspectorResponse(
                    requestId,
                    request,
                    response,
                    connection));
    ...
    private static class ForwardingResponseBody extends ResponseBody {
        ...
        public BufferedSource source() {
            // close on the delegating body will actually close this intercepted source,
            // but it was derived from mBody.byteStream() therefore the close will be forwarded
