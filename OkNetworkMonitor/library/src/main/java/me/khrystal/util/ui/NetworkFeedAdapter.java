...
public class NetworkFeedAdapter extends RecyclerView.Adapter {
    ...
    private static final String TAG = NetworkFeedAdapter.class.getSimpleName();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_network_feed, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final NetworkFeedModel networkFeedModel = mNetworkFeedList.get(position);
