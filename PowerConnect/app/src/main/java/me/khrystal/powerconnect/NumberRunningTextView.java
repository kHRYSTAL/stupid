...
public class NumberRunningTextView extends TextView {
    ...
    private BigDecimal fromBigDecimal = new BigDecimal(0);
    ...
    public void setFromBigDecimal(BigDecimal bigDecimal) {
    ...
    public void playMoneyAnim(String moneyStr) {
        ...
        try {
            ...
            ValueAnimator floatAnimator = ValueAnimator.ofObject(new BigDecimalEvaluator(), fromBigDecimal, bigDecimal);
