...
import static me.khrystal.widget.sliding.SlidingUpPanelLayout.COLLAPSED;
import static me.khrystal.widget.sliding.SlidingUpPanelLayout.EXPANDED;
...
public class CardPanelView extends FrameLayout implements ISlidingUpPanel<CardPanelView> {
    ...
    @Override
    public int getPanelExpandHeight() {
    ...
    public int getPanelTopBySlidingState(@SlidingUpPanelLayout.SlideState int slideState) {
        if (slideState == EXPANDED) {
            ...
            return getPanelExpandHeight() - getPanelCollapsedHeight();
        }
        return 0;
    }
