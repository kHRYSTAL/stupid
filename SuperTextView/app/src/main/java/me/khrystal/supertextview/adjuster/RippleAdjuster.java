...
public class RippleAdjuster extends SuperTextView.Adjuster {
    ...
    protected void adjust(SuperTextView v, Canvas canvas) {
        ...
        solidRectF.set(strokeWidth, strokeWidth, v.getWidth() - strokeWidth, v.getHeight() - strokeWidth);
        ...
        @SuppressLint("WrongConstant") int sc = canvas.saveLayer(0, 0, width, height, null, Canvas.MATRIX_SAVE_FLAG |
