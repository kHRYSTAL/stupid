...
import me.khrystal.suspensionwindow.window.WindowShowService;
import me.khrystal.suspensionwindow.window.WindowUtil;
...
public class WebViewActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        filter.addAction(BROAD_CAST_NAME); // 从系统低层获得这条广播
