...
public class TransferImage extends PhotoView {
    ...
    public static final int CATE_ANIMA_TOGETHER = 100; // 动画类型: 位移和缩放同时执行
    public static final int CATE_ANIMA_APART = 200; // 动画类型: 位移和缩放分开执行
    ...
    public TransferImage(Context context, AttributeSet attrs, int defStyleAttr) {
...
// =======
    ...
    private class Transform {
        ...
        float scale; // 属性ValueAnimator 计算出来的值
        LocationSizeF startRect; // 开始的区域
        LocationSizeF endRect; // 结束的区域
        LocationSizeF rect; // 属性ValueAnimator 计算出来的值
