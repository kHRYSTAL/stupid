...
public class VerifyCodeEditText extends AppCompatEditText implements TextWatcher, VerificationAction {
    ...
    private int mSelectedBackgroundColor; // 选中的颜色
    ...
    public void setCursorVisible(boolean visible) {
        super.setCursorVisible(false); // 隐藏光标显示
    }
