...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int right = child.getRight() + params.rightMargin + mWidthDivider.getIntrinsicWidth();
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        if (isLastRow(parent, itemPosition, spanCount, childCount)) {
            ...
            outRect.set(0, 0, mHeightDivider.getIntrinsicWidth(), mWidthDivider.getIntrinsicHeight());
        }
    }
}
