...
import me.khrystal.weyuereader.widget.animation.CoverPageAnim;
import me.khrystal.weyuereader.widget.animation.HorizonPageAnim;
import me.khrystal.weyuereader.widget.animation.NonePageAnim;
import me.khrystal.weyuereader.widget.animation.PageAnimation;
import me.khrystal.weyuereader.widget.animation.ScrollPageAnim;
import me.khrystal.weyuereader.widget.animation.SimulationPageAnim;
import me.khrystal.weyuereader.widget.animation.SlidePageAnim;

/**
 * usage: 原作者的GitHub Project ModelPath:(https://github.com/PeachBlossom/treader)
 * 绘制页面显示内容的类
 * author: kHRYSTAL
 * create time: 18/5/2
 * update time:
