...
public class IPCMethod {
    ...
    private static Method findAsInterfaceMethod(Class<?> type) {
        for (Class<?> innerClass : type.getDeclaredClasses()) {
            // public static class Stub extends Binder implements Type
    ...
    private Object readValue(Parcel reply) {
        Object result = reply.readValue(getClass().getClassLoader());
    ...
    public boolean equals(Object o) {
        ...
        return method != null ? method.equals(ipcMethod) : ipcMethod.method == null;
    }
